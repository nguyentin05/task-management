...
public class NotificationArchitectureTest {
    ...
    static final ArchRule event_driven_architecture = layeredArchitecture()
            ...
            .layer("ExternalClient").definedBy("..client..")
            .layer("Configuration").definedBy("..configuration..")

            .whereLayer("Service").mayOnlyBeAccessedByLayers("Consumer", "Configuration")
            .whereLayer("ExternalClient").mayOnlyBeAccessedByLayers("Service", "Configuration");
