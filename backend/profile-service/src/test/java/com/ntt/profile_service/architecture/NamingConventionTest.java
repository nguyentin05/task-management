...
public class NamingConventionTest {
    ...
    @ArchTest
    static final ArchRule controllers_should_be_named_ending_with_Controller =
            classes()
    ...
    @ArchTest
    static final ArchRule services_should_be_named_ending_with_Service =
            classes()
    ...
    @ArchTest
    static final ArchRule repositories_should_be_named_ending_with_Repository =
            classes()
