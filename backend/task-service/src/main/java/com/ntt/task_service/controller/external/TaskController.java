...
public class TaskController {
    ...
    ApiResponse<TaskResponse> createTask(
            @PathVariable String columnId, @RequestBody @Valid TaskCreationRequest request) {
    ...
    ApiResponse<TaskResponse> updateTask(@PathVariable String taskId, @RequestBody @Valid TaskUpdateRequest request) {
        return ApiResponse.<TaskResponse>builder()
    ...
    ApiResponse<TaskResponse> moveTask(@PathVariable String taskId, @RequestBody @Valid TaskMoveRequest request) {
        return ApiResponse.<TaskResponse>builder()
    ...
    ApiResponse<TaskResponse> assignMember(@PathVariable String taskId, @RequestBody @Valid TaskAssignRequest request) {
        return ApiResponse.<TaskResponse>builder()
    ...
    ApiResponse<Void> unassignMember(@PathVariable String taskId, @PathVariable String userId) {
    ...
    ApiResponse<Void> deleteTask(@PathVariable String taskId) {
        ...
        return ApiResponse.<Void>builder().message("Xóa task thành công").build();
    }
}
