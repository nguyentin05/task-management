...
│                                                         │
│  Task Service ──────────► PostgreSQL (task_schema)       │
│  Lý do: Complex relations Workspace→Project→Column→Task │
│  (Shared instance với Auth, tách biệt bằng schema)      │
│                                                         │
...
| Task    | PostgreSQL | Complex joins, transactions        | Shared instance với Auth (schema tách)  |
